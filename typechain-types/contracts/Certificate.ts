...
export interface CertificateInterface extends utils.Interface {
  functions: {
    ...
    "getTotalCertificatesMinted()": FunctionFragment;
    "isApprovedForAll(address,address)": FunctionFragment;
    "issueCertificate()": FunctionFragment;
    ...
    "totalIssuedCertificates()": FunctionFragment;
    "transferFrom(address,address,uint256)": FunctionFragment;
    "userNftMapping(address)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "getTotalCertificatesMinted",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "totalIssuedCertificates",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "userNftMapping",
    values: [PromiseOrValue<string>]
  ): string;
...
export interface Certificate extends BaseContract {
  ...
  functions: {
    ...
    getTotalCertificatesMinted(overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    totalIssuedCertificates(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  callStatic: {
    ...
    issueCertificate(overrides?: CallOverrides): Promise<BigNumber>;
